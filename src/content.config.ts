...
export const collections = {
  blog: defineCollection({
    ...
    schema: ({ image }) => z.object({
      ...
      imageAlt: z.string().min(20).max(220).optional(), imageCaption: z.string().max(240).optional(), imageFit: z.enum(['natural','cover','contain']).default('natural'), seoTitle: z.string().min(10).max(90).optional(), readingTime: z.coerce.number().int().positive().optional(),
