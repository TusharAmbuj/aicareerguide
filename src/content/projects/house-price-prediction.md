...
learningOutcomes: ["End-to-end ML workflow", "Regression", "Feature engineering", "Model evaluation", "Model serving"]
deployment: ["FastAPI", "Docker"]
estimatedCost: "Free with local/open datasets"
resumeValue: "High"
interviewTopics: ["Regression", "Train/test split", "Feature engineering", "Evaluation metrics"]
featured: false
draft: false
pubDate: 2026-08-16
---
