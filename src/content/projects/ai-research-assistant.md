...
prerequisites: ["Python", "HTTP APIs", "Basic LLM concepts"]
learningOutcomes: ["RAG", "Embeddings", "Semantic search", "Evaluation", "Citations"]
deployment: ["FastAPI", "Docker"]
estimatedCost: "API/model usage may incur provider charges"
resumeValue: "High"
interviewTopics: ["RAG", "Embeddings", "Reranking", "Evaluation", "Prompt design"]
featured: false
draft: false
pubDate: 2026-08-16
---
